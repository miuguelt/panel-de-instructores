...
function initTableFilters() {
    ...
    tableContainers.forEach(container => {
        ...
        if (hasDataEstado) {
            ...
            // Set default to EN_FORMACION if exists
            if (states.has('EN_FORMACION')) {
                stateSelect.value = 'EN_FORMACION';
            }
        ...
        const applyFilters = () => {
            ...
            if (searchTerm !== '' || (stateTerm !== '' && stateTerm !== 'EN_FORMACION')) {
        ...
        // Initial apply if default is set
        applyFilters();
    });
}
